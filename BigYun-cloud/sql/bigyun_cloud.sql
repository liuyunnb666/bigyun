CREATE DATABASE IF NOT EXISTS `dy-cloud` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          'BigYun科技',   0, 'BigYun', '', 'demo@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '深圳总公司', 1, 'BigYun', '', 'demo@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '长沙分公司', 2, 'BigYun', '', 'demo@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, 'BigYun', '', 'demo@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, 'BigYun', '', 'demo@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, 'BigYun', '', 'demo@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, 'BigYun', '', 'demo@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, 'BigYun', '', 'demo@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, 'BigYun', '', 'demo@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, 'BigYun', '', 'demo@example.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', 'BigYun', '00', 'admin@example.com', '', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  105, 'dy',    'BigYun', '00', 'demo@example.com',  '', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
...
insert into sys_menu values('4', 'BigYun官网', '0', '4', 'http://bigyun.vip', null, '', '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, 'BigYun官网地址');
-- 二级菜单
...
insert into sys_job values(1, '系统默认（无参）', 'DEFAULT', 'dyTask.dyNoParams',        '0/10 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');
insert into sys_job values(2, '系统默认（有参）', 'DEFAULT', 'dyTask.dyParams(\'dy\')',  '0/15 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');
insert into sys_job values(3, '系统默认（多参）', 'DEFAULT', 'dyTask.dyMultipleParams(\'dy\', true, 2000L, 316.50D, 100)',  '0/20 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2018-07-01 BigYun新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：2018-07-01 BigYun系统凌晨维护', '1', '维护内容',   '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('3', 'BigYun社区版说明', '1', '<p>BigYun Cloud Community Edition keeps the base RuoYi-Cloud style capabilities and Provider configuration center. Configure local infrastructure before production use.</p>', '0', 'admin', sysdate(), '', null, '管理员');
...
create table sys_provider_config (
  ...
  region           varchar(100)    default '' comment '地域',
  bucket_name      varchar(100)    default '' comment 'Bucket 名称',
  access_key       varchar(1024)   default '' comment '加密 AccessKey',
  secret_key       varchar(1024)   default '' comment '加密 SecretKey',
...
insert into sys_menu values('117',  '配置中心', '3', '4', 'provider', '', '', '', 1, 0, 'M', '0', '0', '', 'cloud', 'admin', sysdate(), '', null, 'Provider 配置目录');
insert into sys_menu values('118',  'Provider配置', '117', '1', 'config', 'provider/config/index', '', '', 1, 0, 'C', '0', '0', 'provider:config:list', 'server', 'admin', sysdate(), '', null, 'Provider 配置菜单');
insert into sys_menu values('1181', '配置查询', '118', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'provider:config:query', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1182', '配置新增', '118', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'provider:config:add', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1183', '配置修改', '118', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'provider:config:edit', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1184', '配置删除', '118', '4', '#', '', '', '', 1, 0, 'F', '0', '0', 'provider:config:remove', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1185', '配置导出', '118', '5', '#', '', '', '', 1, 0, 'F', '0', '0', 'provider:config:export', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('122',  'Provider配置中心', '0', '5', 'config', null, '', '', 1, 0, 'M', '0', '0', '', 'cloud', 'admin', sysdate(), '', null, 'Provider 配置中心目录');
insert into sys_menu values('123',  '配置概览', '122', '1', 'dashboard', 'config/dashboard/index', '', '', 1, 0, 'C', '0', '0', 'config:dashboard:view', 'dashboard', 'admin', sysdate(), '', null, 'Provider 配置概览');
insert into sys_menu values('124',  'OCR配置', '122', '2', 'ocr', 'config/ocr/index', '', '', 1, 0, 'C', '0', '0', 'provider:config:list', 'document', 'admin', sysdate(), '', null, 'OCR Provider 配置菜单');
insert into sys_menu values('125',  '人脸识别配置', '122', '3', 'face', 'config/face/index', '', '', 1, 0, 'C', '0', '0', 'provider:config:list', 'user', 'admin', sysdate(), '', null, 'Face Provider 配置菜单');
insert into sys_menu values('126',  '视觉理解配置', '122', '4', 'vision', 'config/vision/index', '', '', 1, 0, 'C', '0', '0', 'provider:config:list', 'eye-open', 'admin', sysdate(), '', null, 'Vision Provider 配置菜单');
