package com.bigyun.gen.controller;
...
import com.bigyun.gen.config.GenConfig;
import com.bigyun.gen.domain.GenTable;
import com.bigyun.gen.domain.GenTableColumn;
import com.bigyun.gen.service.IGenTableColumnService;
import com.bigyun.gen.service.IGenTableService;
...
public class GenController extends BaseController
{
            ...
            @RequestParam(value = "databaseName", required = false) String databaseName)
    {
        ...
        genTableService.importGenTable(tableList, tplWebType, databaseName);
        return success();
    }
    ...
    @RequiresPermissions("tool:gen:list")
    @GetMapping("/selectDatabaseNameList")
    public AjaxResult selectDatabaseNameList()
    {
        return success(genTableService.selectDatabaseNameList());
    }
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"bigyun.zip\"");
