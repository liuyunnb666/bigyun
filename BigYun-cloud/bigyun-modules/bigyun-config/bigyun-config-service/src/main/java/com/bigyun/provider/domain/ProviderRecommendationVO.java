...
public class ProviderRecommendationVO implements Serializable
{
    ...
    private List<ProviderModelCatalog> models = new ArrayList<>();
    ...
    public List<ProviderModelCatalog> getModels()
    {
        return models;
    }

    public void setModels(List<ProviderModelCatalog> models)
    {
        this.models = models == null ? new ArrayList<ProviderModelCatalog>() : models;
    }
}
