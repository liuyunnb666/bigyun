...
import com.bigyun.system.domain.vo.TreeSelect;
import com.bigyun.system.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    /**
     * 查询部门列表（不应用数据权限过滤，供内部 Feign 调用）。
     *
     * <p>区别于 {@link #selectDeptList}，此方法不加 {@code @DataScope}，
     * 确保跨模块调用时返回全量科室底稿，由调用方自行做权限过滤。</p>
     */
    @Override
    public List<SysDept> selectDeptListWithoutDataScope(SysDept dept)
    {
        return deptMapper.selectDeptList(dept);
    }
