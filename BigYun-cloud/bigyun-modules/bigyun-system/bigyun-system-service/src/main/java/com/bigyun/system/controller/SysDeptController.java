...
public class SysDeptController extends BaseController
{
     ...
     */
    @InnerAuth
    @GetMapping("/inner/{deptId}")
    public R<SysDept> innerGetInfo(@PathVariable("deptId") Long deptId)
    {
    ...
    public R<List<SysDept>> internalList()
    {
        SysDept query = new SysDept();
        query.setStatus(UserConstants.NORMAL);
        return R.ok(deptService.selectDeptListWithoutDataScope(query));
    }
}
