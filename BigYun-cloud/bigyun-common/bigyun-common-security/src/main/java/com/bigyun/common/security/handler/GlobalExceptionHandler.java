package com.bigyun.common.security.handler;
...
import com.bigyun.common.core.exception.DemoModeException;
...
public class GlobalExceptionHandler
{
    ...
    {
        String requestURI = request.getRequestURI();
        log.warn("请求地址'{}',静态资源不存在.", requestURI);
    ...
    public AjaxResult handleRuntimeException(RuntimeException e, HttpServletRequest request)
    {
        ...
        return AjaxResult.error(SYSTEM_ERROR_MESSAGE);
    }
