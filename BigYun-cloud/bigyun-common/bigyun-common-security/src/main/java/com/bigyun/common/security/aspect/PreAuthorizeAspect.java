...
public class PreAuthorizeAspect
{
     ...
     */
    public static final String POINTCUT_SIGN = " @annotation(com.bigyun.common.security.annotation.RequiresLogin) || "
            + "@annotation(com.bigyun.common.security.annotation.RequiresPermissions) || "
            + "@annotation(com.bigyun.common.security.annotation.RequiresRoles)";
