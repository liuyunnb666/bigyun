...
import com.bigyun.gateway.config.properties.CaptchaProperties;
...
{
    private final static String[] VALIDATE_URL = new String[] { "/auth/login", "/auth/loginNew", "/auth/register" };
